...
namespace DALtpExpaceo
{
    public class MySQLAccess
    {
        ...
        public MySqlDataReader GetData(string[] champs, string[] table, Dictionary<string, string> clauseWhere = null, string[] orderBy = null)
        {
            //"SELECT 'id' FROM 'user' WHERE 'name' = 'chloe'"
            string requete = "";
            MySqlCommand query = connection.CreateCommand();
